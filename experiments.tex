...
For 13 residues, the atomic coordinates of the central alpha carbon were not present in the PDB files, so some features see Appendix \ref{appendix:features} for more detail} angle could not be calculated.
