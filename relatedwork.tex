...
Esmaielbeiki, Krawczyk, Knapp, Nebel, \& Deane ~\cite{esmaielbeiki2015} describe three slightly different computational problems: protein interaction prediction, protein interface prediction, and protein-protein docking~\cite{esmaielbeiki2015}.
...
In PAIRPred, Minhas, Geiss, \& Ben-Hur~\cite{minhas2014} incorporated custom symmetric symmetric kernels into an SVM formulation~\cite{minhas2014}.
